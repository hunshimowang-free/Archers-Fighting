...
void LoginScene::createLoginButton()
{
	...
	loginButton->setPosition(Vec2(visibleSize.width / 2, visibleSize.height / 2-50));
...
void LoginScene::initUserBox()
{
	...
	Vec2 origin = Director::getInstance()->getVisibleOrigin();
	////////////////////////////////////*************************************!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	usernameBG = Sprite::create("Scene/blue_button01.png");
	...
	usernameInput->setPosition(Vec2(50, 50));
